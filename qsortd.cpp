...
void qsortds64(int first, int last, double *data, unsigned int *slave) {
    int lower, upper;
    unsigned int itemp;
    double ftemp, split;
...
void qsort64ssii(int first, int last, unsigned int *data, short int *slave1, int *slave2) {
    int lower, upper, itemp;
    unsigned int ftemp, split;
